...
EntitySelection.prototype.update = function()
{
	...
	const controlsAll = true; //g_SimState.players[g_ViewedPlayer] && g_SimState.players[g_ViewedPlayer].controlsAll;
	const removeOwnerChanges = !g_IsObserver && !controlsAll && this.selected.size > 300;
...
{
	force = true; //force || g_SimState.players[g_ViewedPlayer]?.controlsAll;
